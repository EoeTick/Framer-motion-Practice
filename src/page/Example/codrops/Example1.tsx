...
// reference https://tympanus.net/codrops/2023/05/17/recreating-the-gradient-mask-hover-effect-from-evervault/
const Example1 = () => {
  return (
    <div className="body">
      <div className="grid">
        <div className="grid__item">
          ...
          <p className="grid__item-label">
            We designed and developed a visually appealing website for
            CodeCrafters, highlighting their coding expertise.
          </p>
